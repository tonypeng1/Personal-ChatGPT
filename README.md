...
This app (version 0.11.0) currently has the following features.
...
```
To create a Python virtual environment, check out version 0.11.0 of this APP, and install the project,
```
cd Personal-ChatGPT
python3 -m venv .venv
...
```
docker build -t streamlit-mysql:0.11.0 .
docker compose up
```
## Medium Article
