...
This app (version 1.3.0) currently has the following features:

1. Switch between the LLM model of gpt-4o, claude-3-5-sonnet-20241022, mistral-large-latest, llama-3.1-sonar-large-128k-online (perplexity), and gemini-1.5-pro-exp-0801 anytime in a chat session.
...
```
To create a Python virtual environment, check out version 1.3.0 of this APP, and install the project,
```
cd Personal-ChatGPT
python3 -m venv .venv
...
```
docker build -t streamlit-mysql:1.3.0 .
docker compose up
```
## Medium Article
